...
let arrayPalabras =["AGUA", "ORQUIDEA", "ATMOSFERA", "ARBOL", "FOTOSINTESIS", "RECICLAR"];
//Arreglo que contiene las ayudas de cada palabra
let ayudas = [
    "Nos ayuda a hidratar",
    "Flor nacional de Colombia",
    "Capa de gas que rodea la tierra",
    "Planta de tallo leñoso",
    "Proceso en el cual las plantas obtienen alimento",
    "Proceso por el cual le damos una nueva vida a los objetos"
]
...
function cargarNuevaPalabra(){
    ...
    if(cantPalabrasJugadas>6){
        ...
        arrayPalabras =["AGUA", "ORQUIDEA", "ATMOSFERA", "ARBOL", "FOTOSINTESIS", "RECICLAR"];
        ayudas = [
            "Nos ayuda a hidratar",
            "Flor nacional de Colombia",
            "Capa de gas que rodea la tierra",
